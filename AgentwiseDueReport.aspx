<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="AgentwiseDueReport.aspx.cs" Inherits="AgentwiseDueReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Agentwise Due <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#"> Agentwise Due </a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i> Agentwise Due  Details
                </h3>
            </div>
            <div class="box-body">
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnlHide" runat="server" Visible="false">
                            <div id="divPrint">
                                <div align="center">
                                    <span style="font-size: 18px; color: #0252aa;">AGENT WISE DUE REPORT</span>
                                </div>
                                <div style="width: 100%;">
                                    ...
                                    <div style="width: 100%;">
                                        <span style="font-size: 18px; font-weight: bold; padding-left: 27%; text-decoration: underline;
                                            color: #0252aa;">Agentwise Due</span><br />
                                        <div>
                                            ...
                                            <asp:Label ID="ldltdat" runat="server" ForeColor="Red" Text=""></asp:Label>
                                        </div>
                                    </div>
                                    <br />
                                    <br />
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="width: 30%;">
                                            <span style="font-weight: bold; font-size: 14px;">AGENT</span>
                                        </td>
                                        <td style="width: 30%;">
