<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="testoffer.aspx.cs" Inherits="testoffer" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Total Indent Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Total Indent Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Total Indent Report Details
                </h3>
            </div>
            <div class="box-body">
                    ...
                    <ContentTemplate>
                        <div runat="server" id="d">
                            ...
                            <asp:Panel ID="pnlHide" runat="server" Visible="false">
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">TOTAL INDENT
                                                REPORT</span>
                                        </div>
                                        <div style="width: 100%;">
                                            <br />
                                     ...
                                     <asp:GridView ID="grdofferReports" runat="server" CellPadding="5" CellSpacing="5" ForeColor="White"
                            ...
                            <asp:Panel ID="PanelDen" runat="server" Visible="false">
                                <asp:TextBox ID="txtMobNo" runat="server" CssClass="txtsize"></asp:TextBox>
