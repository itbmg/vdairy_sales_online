<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="RouteInfo.aspx.cs" Inherits="RouteInfo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Route Info<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Route Info Details
                </h3>
            </div>
            <div class="box-body">
                    ...
                    <ContentTemplate>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlRouteName" runat="server" CssClass="inputText">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 5px;">
                                </td>
                            ...
                            <div id="divPrint">
                                <div style="width: 100%;">
                                    ...
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">DOC STATEMENT</span>
                                        </div>
                                        <div align="center">
                                        ...
                                        <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" Font-Bold="true">
                                            <EditRowStyle BackColor="#999999" />
                                            <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                                            <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" ForeColor="Black" Font-Italic="False"
                                                Font-Names="Raavi" Font-Size="Small" />
                                            <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                            <RowStyle BackColor="#ffffff" ForeColor="#333333" Height="100" />
                                        ...
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="width: 30%;">
                                                    <span style="font-weight: bold; font-size: 14px;">SALESMAN</span>
                                                </td>
                                                <td style="width: 30%;">
