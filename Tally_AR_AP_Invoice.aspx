<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Tally_AR_AP_Invoice.aspx.cs" Inherits="Tally_AR_AP_Invoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Tally AR&AP Invoice<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#">Tally Reports</a></li>
            <li><a href="#">Tally AR&AP Invoice</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Tally AR&AP Invoice Details
                </h3>
            </div>
            <div class="box-body">
                             ...
                             <td>
                                ...
                                <td style="height:40px;">
                                    <asp:DropDownList ID="ddltype" runat="server" CssClass="form-control">
                                        <asp:ListItem>AR Invoice</asp:ListItem>
                                        <asp:ListItem>AP Invoice</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                  <td style="width: 5px;">
                                </td>
                            ...
                            <div id="divPrint">
                                <div style="width: 100%;">
                                    ...
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">Tally AR&AP Invoice Details</span>
                                        </div>
                                        <div align="center">
