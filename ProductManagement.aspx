<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ProductManagement.aspx.cs" Inherits="ProductManagement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function productsdata_categoryname_onchange() {
            ...
            var s = function (msg) {
                if (msg) {
                    fillBranchproductsdata_subcatgry(msg);
                }
                else {
                }
            };
        ...
        function fillBranchproductsdata_subcatgry(msg) {
        ...
        function fillproductsdata_products(msg) {
            $("#td_save").css("display", "block");
                ...
                for (var i = 0; i < msg.length; i++) {
                    if (Temptable.indexOf(msg[i].ProductName) == -1) {
                        $(tablestrctr).append('<tr><td>' + k + '</td><td class="1">' + msg[i].ProductName + '</td><td name="idprevsmsstatus" style="display:none"><input id="hdnempsno" class="clsProductsno" type="hidden" value="' + msg[i].sno + '" /></td><td><input type="checkbox" class="checkedid" id="ckbpresent" onclick="selectall_checks(this)";  value="' + msg[i].sno + '"></td></tr>');
                        k++;
                        Temptable.push(msg[i].ProductName);
                    }
                    else {
                    }
        ...
        function btnBranchProductsSaveClick() {
            var tempproductlist = [];
            var BranchId = document.getElementById('ddlSalesOffice').value;
...
//                var sgst = $row.find('.clssgst').val();
            ...
            //                    tempproductlist.push(abc);
            //            });
            var Data = { 'operation': 'saveBranch_Products_Details', 'BranchId': BranchId, 'BrancProductList': tempproductlist };
            var s = function (msg) {
                if (msg) {
                    alert(msg);
                    document.getElementById('div_students').innerHTML = "";
                        ...
                        <div>
                            <ul class="nav nav-tabs">
                                <li id="id_tab_BranchProduct" class="active"><a data-toggle="tab" href="#" onclick="showBranchProducts()">
                                    <i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;BranchProducts</a></li>
                                <li id="id_tab_AgentProduct" class="" ><a data-toggle="tab" href="#" onclick="showAgentProducts()">
                               ...
                               <%-- <div id="BranchProductsShowLogs" align="center">
                                ...
                                <div id="BranchProductsShowLogs" align="right" class="input-group" style="display: block;
                                    ...
                                    <div class="input-group-addon" style="width: 100px;">
                                        ...
                                        <span onclick="showDistributordesign();">AssignProducts</span>
                                    </div>
                                </div>
                               <%-- <div id="div_BranchProductsData">
                                </div>--%>
                                <div id='BranchProducts_FillForm' style="display: none;">
                                    <table align="left">
                                        <tr>
                                            <td>
                                                <label>
                                        ...
                                        <tr id="td_save" style="display:none;">
                                            <td style="padding-left: 90px;">
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <span class="glyphicon glyphicon-ok" id="spnBranchClick" onclick="btnBranchProductsSaveClick()">
                                                        </span><span id="spnBranchClick1" onclick="btnBranchProductsSaveClick()">Save</span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
