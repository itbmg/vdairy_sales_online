<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Retail_agents_map.aspx.cs" Inherits="Retail_agents_map" %>
   ...
   <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDGYPgYpwZ4ZQCLCAujetDwArlVBC_S9TI&sensor=false"></script>
    ...
    <script type="text/javascript">
        function btn_generate_Click() {
            ...
            var data = { 'operation': 'GetRetail_Agent_Locations', 'startdt': startdt, 'routes': checkedroutes, 'BranchID': BranchID };
            var s = function (msg) {
                if (msg) {
                    closeinfowindow();
                    polyroute(msg);
...
//                }
                ...
                attachInfowindow(marker, location, "Agent Name : " + pltname + '</b><br />' + "   Route Name : " + dispname);
            }
        }
