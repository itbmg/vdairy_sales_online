<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TotalLeakReturnDispatch.aspx.cs" Inherits="TotalLeakReturnDispatch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            TotalLeak Return Despatch<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">TotalLeak Return Despatch</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>TotalLeak Return Despatch Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td style="height:40px;">
                                    <asp:DropDownList ID="ddlReportType" runat="server" CssClass="form-control" AutoPostBack="True"
                                        ...
                                        <asp:ListItem>Plant Wise</asp:ListItem>
                                    </asp:DropDownList>
                                </td>--%>
                                <td style="width: 5px;">
                                </td>
                            ...
                            <div id="divPrint">
                                <div align="center">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">Total Leaks
                                                and Returns Report</span>
                                        </div>
                                        <div align="center">
                                            <table>
                                                <tr>
