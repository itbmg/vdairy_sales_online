<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="EditReceipt.aspx.cs" Inherits="EditReceipt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function btnupdatereceiptDetails() {
            var refno = document.getElementById("txtrefno").value;
            if (refno == "") {
                alert("Please enter receipt ref no");
                return false;
            }
            ...
            var data = { 'operation': 'btnupdatereceiptDetails', 'refno': refno, 'fromdate': fromdate, 'todate': todate };
            var s = function (msg) {
                if (msg) {
                    alert(msg);
            ...
            <div class="box-body">
                <table align="center">
                    <tr>
                        <td>
                            <label for="lblSalesType">
                                Receipt Ref No:</label>
                        </td>
                        <td style="height: 40px;">
                            <input type="text" id="txtrefno" class="form-control" placeholder="Enter Receipt Ref No" />
                        </td>
                    </tr>
                    <tr>
                        <td nowrap>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="button" id="btnclick" value="Edit Receipt" class="btn btn-primary" onclick="btnupdatereceiptDetails();" />
                        </td>
                    </tr>
                </table>
            </div>
