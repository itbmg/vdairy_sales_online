<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="monthlysummeryrpt.aspx.cs" Inherits="monthlysummeryrpt" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Brach Sale<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Brach Sales</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Brach Sale
                </h3>
            </div>
            <div class="box-body">
                        ...
                        <asp:Panel ID="pnlHide" runat="server" Visible="false">
                            <div id="divPrint">
                                ...
                                <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                                    GridLines="Both" Font-Bold="true" OnRowCreated="grdReports_RowCreated">
                                ...
                                <br />
                                <div align="center">
                                    <span style="font-size: 18px; color: #0252aa;">View SubCategory Wise</span>
                                </div>
                                <table>
                                    <tr>
                                        <td style="width: 130px;" id="ddltype">
                                            <asp:DropDownList ID="ddlmonth" runat="server" CssClass="form-control">
                                                ...
                                                <asp:ListItem Value="03" Text="March">March</asp:ListItem>
                                                <asp:ListItem Value="04" Text="Aprial">Aprial</asp:ListItem>
                                                <asp:ListItem Value="05" Text="May">May</asp:ListItem>
                                                <asp:ListItem Value="06" Text="June">June</asp:ListItem>
                                                <asp:ListItem Value="07" Text="July">July</asp:ListItem>
                                                <asp:ListItem Value="08" Text="August">August</asp:ListItem>
                                                <asp:ListItem Value="09" Text="September">September</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:Button ID="Button1" Text="Generate" runat="server"
                                                CssClass="btn btn-primary" OnClick="btnsubGenerate_Click" />
                                        </td>
                                    </tr>
                                </table>
                                <asp:GridView ID="GridView1" runat="server" ForeColor="White" CssClass="gridcls" Width="100%"
                                    GridLines="Both" Font-Bold="true" OnRowCreated="grdReports_RowCreated">
                                    <EditRowStyle BackColor="#999999" />
                                    <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                                    <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" ForeColor="Black" Font-Italic="False"
