<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PlantSales.aspx.cs" Inherits="PlantSales" %>
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Net Sales Details
                </h3>
            </div>
            <div class="box-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control">
                                            ...
                                            <asp:ListItem Value="10" Text="Curd">Curd</asp:ListItem>
                                            <asp:ListItem>ButterMilk</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width:6px;"></td>
                                    <td>
                                ...
                                <div style="width: 100%;">
                                    ...
                                    <div style="width: 100%;">
                                        <span style="font-size: 14px; font-weight: bold; padding-left: 27%; text-decoration: underline;
                                            color: #0252aa;">Net Sales Report</span><br />
                                        <div>
