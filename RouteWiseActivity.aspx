<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="RouteWiseActivity.aspx.cs" Inherits="RouteWiseActivity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Route Wise Activity<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Route Wise Activity</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Route Wise Activity Details
                </h3>
            </div>
            <div class="box-body">
                                ...
                                <div style="width: 100%;">
                                    ...
                                    <div style="width: 100%;">
                                        <span style="font-size: 14px; font-weight: bold; padding-left: 27%; text-decoration: underline;
                                            color: #0252aa;">Route Wise Activity Report</span><br />
                                        <div>
