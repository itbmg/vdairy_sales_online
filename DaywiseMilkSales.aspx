...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Daywise Milk sales<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:DropDownList ID="ddlReportType" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlReportType_SelectedIndexChanged"
                                        ...
                                        <asp:ListItem Value="3" Text="Curd">BiProdutcs</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 5px;">
                                </td>
                                <td>
                                    ...
                                    <asp:Panel ID="SubCategorypannel" runat="server">
                                    ...
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <div style="width: 100%;">
                                            <span style="font-size: 18px; font-weight: bold; text-decoration: underline; color: #0252aa;">
                                                Day Wise Milk Sales Report</span><br />
                                            <div>
                                            </div>
                                        </div>
                                        <div align="center">
                                        ...
                                        <asp:GridView ID="grdtotal_dcReports" runat="server" ForeColor="White" Width="100%"
                                            GridLines="Both" Font-Size="Smaller" OnRowDataBound="grdtotal_dcReports_RowDataBound">
