<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditSalesOfficeCollections.aspx.cs" Inherits="EditSalesOfficeCollections" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fill_Editcollectiondetails(msg) {
            ...
            results += '</table></div>';
            $("#grid_Editcollections").html(results);
        }
            ...
            <div class="box-body">
             <table id="divgrid" class="gridclass">
                  <tr>
                    ...
                    <input id="btn_Editcollections" type="button" name="submit" value='Collections' class="btn btn-primary" />
                </div>
                                    
                                    </td>
                                </tr>
                </table>
                <div id="grid_Editcollections">
                </div>
                <table style="width: 100%;display:none;" id="tblEditCollections">
                    <tr>
                        <td style="width: 50%;">
                            <table align="center">
                                <tr>
