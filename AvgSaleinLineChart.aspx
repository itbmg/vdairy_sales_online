<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="AvgSaleinLineChart.aspx.cs" Inherits="AvgSaleThreeDays" %>
    ...
    <div id="example" class="k-content">
        ...
        <script type="text/javascript">
            ...
            function DetailsValidating() {
                ...
                var data = { 'operation': 'getAvglastThreeDaysSaleReport', 'Fromdate': Fromdate,'Todate':Todate };
                var s = function (msg) {
                    if (msg) {
            ...
            function createChartmethod(databind) {
              var datainXSeries = 0;
                ...
                textname="Total sales Vs Avg Sales --> " + avgqty;
