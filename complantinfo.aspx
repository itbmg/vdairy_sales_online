<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="complantinfo.aspx.cs" Inherits="complantinfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>
            Complaints<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Complaints Details
                </h3>
            </div>
            <div class="box-body">
                <table align="center">
                    <tr>
                        ...
                        <td>
                            <label>
                                Route</label><span style="color: red; font-weight: bold">*</span>
                        ...
                        <td>
                            <label>
                                Agent</label><span style="color: red; font-weight: bold">*</span>
                    ...
                    <tr class="divPayTodesc">
                        <td>
                            <label>
                                Reason</label>
                                <textarea id="txtDecription" class="form-control" placeholder="Enter Head Description"></textarea>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <span class="glyphicon glyphicon-ok" id="btnSave1" onclick="Headvalidation()"></span>
                                                <span id="btnSave" onclick="Headvalidation()">SAVE</span>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
