<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="LeaksAndReturns.aspx.cs" Inherits="LeaksAndReturns" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Leaks Returns<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Leaks Returns</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Leaks Returns Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td style="height: 40px;">
                                    <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem>Puff Leaks</asp:ListItem>
                            ...
                            <div id="divPrint">
                                <div align="center">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">Leaks and
                                                Returns Report</span>
                                        </div>
                                        <div style="width: 100%;">
                                            <br />
