<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="HelperCharges.aspx.cs" Inherits="HelperCharges" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Helper Charges<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Helper Charges</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Helper Charges Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlreporttype" runat="server" CssClass="form-control">
                                        <asp:ListItem>Helper Charges</asp:ListItem>
                                        <asp:ListItem>Dispatch Qty</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 5px;">
                                </td>
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="pnlHide" runat="server" Visible="false">
                            <div id="divPrint">
                                ...
                                <div align="center">
                                    <span style="font-size: 18px; color: #0252aa;">HELPER CHARGES SHEET</span>
                                </div>
                                <div align="center">
                                    <table>
                                        <tr>
                                ...
                                <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" GridLines="Both"
                                    CssClass="EU_DataTable" Font-Size="Smaller">
