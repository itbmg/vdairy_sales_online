<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RouteInventory.aspx.cs" Inherits="RouteInventory" %>
                ...
                <tr>
                    <td>
                        <asp:Panel ID="Ptype" runat="server">
                            <asp:DropDownList ID="ddlType" runat="server" CssClass="inputText">
                            <asp:ListItem>Dispatch Wise</asp:ListItem>
                            <asp:ListItem>Day wise</asp:ListItem>
                            </asp:DropDownList>
                        </asp:Panel>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlDispName" runat="server" CssClass="inputText">
                        </asp:DropDownList>
                    </td>
                    <td>
                    ...
                    <div style="width: 100%;">
                        ...
                        <div style="width: 100%;">
                            <span style="font-size: 18px; font-weight: bold; padding-left: 27%; text-decoration: underline;
                                color: #0252aa;">Day Wise Route Inventory</span><br />
                            <div>
                                <div style="width: 30%; float: left; padding-left: 7%;">
