<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="OfferIndent.aspx.cs" Inherits="OfferIndent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Offer Indent Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Offer Indent Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Offer Indent Report Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlreporttype" runat="server" CssClass="form-control">
                                        <asp:ListItem>INDENT</asp:ListItem>
                            ...
                            <div id="divPrint">
                                <div style="width: 100%;">
                                    ...
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">Offer Report</span>
                                        </div>
                                        <div align="center">
                                            <table style="width: 50%;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label Text="" runat="server" ForeColor="Red" ID="lbltype"></asp:Label>
                                                    </td>
                                                    <td>
                                                        Date:
                                                    </td>
