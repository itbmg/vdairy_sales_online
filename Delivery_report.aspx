<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Delivery_report.aspx.cs" Inherits="Dreport" %>
                            ...
                            <table>
                                <tr>
                                    <asp:Panel ID="PBranch" runat="server">
                                        ...
                                        <td>
                                            <asp:CheckBox ID="chkDispatch" runat="server" Text="Direct Dispatch" AutoPostBack="True"
                                                OnCheckedChanged="chkDispatch_CheckedChanged"></asp:CheckBox>
                                        </td>
                                        <td style="width: 5px;">
                                        </td>
                                        <td>
                        ...
                        <div runat="server" id="d">
                            ...
                            <asp:Panel ID="pnlHide" runat="server" Visible="false">
                                <div id="divPrint">
                                    ...
                                    <div align="center">
                                        <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">DELIVERY
                                            REPORT</span>
                                    </div>
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td style="width: 15%;">
                                                <asp:Label ID="lblEmpName" runat="server" Text="" ForeColor="Red"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    GridLines="Both" Font-Bold="true" OnRowDataBound="grdReports_RowDataBound">
                                     ...
                                     <asp:GridView ID="grdReports1" runat="server" CssClass="gridcls"
                                    GridLines="Both" Font-Bold="true" OnRowDataBound="grdReports_RowDataBound">
                                        <EditRowStyle BackColor="#999999" />
                                        <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                                        <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" ForeColor="Black" Font-Italic="False"
                                    ...
                                    <asp:GridView ID="grdReports2" runat="server" CssClass="gridcls"
                                    GridLines="Both" Font-Bold="true" OnRowDataBound="grdReports_RowDataBound">
                                        <EditRowStyle BackColor="#999999" />
                                        <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                                        <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" ForeColor="Black" Font-Italic="False"
                                    ...
                                    <asp:GridView ID="grdReports3" runat="server" CssClass="gridcls"
                                    GridLines="Both" Font-Bold="true" OnRowDataBound="grdReports_RowDataBound">
                                        <EditRowStyle BackColor="#999999" />
                                        <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                                        <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" ForeColor="Black" Font-Italic="False"
                            ...
                            <asp:Label ID="lblmsg" runat="server" ForeColor="Red" Text="" Font-Size="20px"></asp:Label>
                                    ...
                                    <asp:Button ID="Button1" runat="server" Text="Print" OnClick="Print" />
            </div>
        </div>
    </section>
</asp:Content>
