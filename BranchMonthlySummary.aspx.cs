...
public partial class AgentMonthlyProducts : System.Web.UI.Page
{
    ...
    void GetReport()
    {
        try
        {
            ...
            months = ((dateSpan.Days % 365) / 31) + (years * 12);
                ...
                if (months != 0)
            {
                ...
                for (int k = 0; k < months; k++)
                {
                    ...
                    {
                        firstmonth = GetLowMonthRetrive(fromdate.AddMonths(k + 1));
                                ...
                                foreach (DataRow dr in dtAgent.Rows)
                                {
                                    try
                                    {
                                        if (drAgent["Branch Name"].ToString() == dr["BranchName"].ToString())
                                        {
                                            ...
                                            if (_count == 1 || _count == 3 || _count == 5 || _count == 7)
                                            {
                                                previousDqty = delQty;
                                            }
                                            ...
                                            if (_count == 2 || _count == 4 || _count == 6 || _count == 8)
                                            {
                                                //Report.Rows[temp][Count + M] = previousDqty - delQty;
                                                Report.Rows[temp][Count + i + 1] = previousDqty - delQty;
                                                previousDqty = 0;
                                                N++;
                                            }
                                            _count++;
            ...
            else
            {
                ...
                lblmsg.Text = "Please select two or Four Months months only";
                grdReports.DataSource = Report;
                grdReports.DataBind();
            }
        }
    ...
    protected void grdReports_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            if (months == 2)
            {
                if (e.Row.Cells[1].Text.Contains("Difference"))
                {
                    e.Row.Cells[1].Text = "Difference";
                }
                if (e.Row.Cells[2].Text.Contains("Difference"))
                {
                    e.Row.Cells[2].Text = "Difference";
                }
                if (e.Row.Cells[3].Text.Contains("Difference"))
                {
                    e.Row.Cells[3].Text = "Difference";
                }
                if (e.Row.Cells[4].Text.Contains("Difference"))
                {
                    e.Row.Cells[4].Text = "Difference";
                }
            }
            else if (months == 4)
            {
                ...
                if (e.Row.Cells[5].Text.Contains("Difference"))
                {
                    e.Row.Cells[5].Text = "Difference";
                }
                if (e.Row.Cells[6].Text.Contains("Difference"))
                {
                    e.Row.Cells[6].Text = "Difference";
                }
                if (e.Row.Cells[7].Text.Contains("Difference"))
                {
                    e.Row.Cells[7].Text = "Difference";
                }
            }
        }
    }
