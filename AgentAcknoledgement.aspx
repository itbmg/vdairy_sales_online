<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AgentAcknoledgement.aspx.cs" Inherits="AgentAcknoledgement" %>
                    ...
                    <tr>
                        <td>
                            <asp:Panel ID="PBranch" runat="server">
                                <asp:DropDownList ID="ddlSalesOffice" runat="server" CssClass="inputText" AutoPostBack="True"
                                    OnSelectedIndexChanged="ddlSalesOffice_SelectedIndexChanged">
                                </asp:DropDownList>
                            </asp:Panel>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlDispName" runat="server" CssClass="inputText" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlDispName_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlAgentName" runat="server" CssClass="inputText">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:TextBox ID="txtFromdate" runat="server" Width="205px" CssClass="inputText"></asp:TextBox>
                        ...
                        <td>
                            <asp:Button ID="btnGenerate" Text="Generate" runat="server" OnClientClick="OrderValidate();"
                                CssClass="SaveButton" OnClick="btnGenerate_Click" Style="height: 30px; width: 150px;
                                font-size: 15px;" />
                        </td>
                    </tr>
                </table>
            ...
            <asp:Panel ID="pnlHide" runat="server" Visible="false">
                <div id="divPrint">
                    <div style="width: 100%;">
                        ...
                        <div style="width: 100%;">
                            <span style="font-size: 14px; font-weight: bold; padding-left: 35%; text-decoration: underline;
                                color: #0252aa;">ACKNOWLEDGEMENT STATEMENT</span><br />
                            <div>
                            <div style="width: 40%; float: left; padding-left: 7%;">
                                    <span style="font-weight: bold;">Route Name: </span>
                            <asp:Label ID="lblroutename" runat="server" Style="font-size: 11px;" ForeColor="Red"
                                        Text=""></asp:Label>
                            </div>
                                <div style="width: 40%; float: left; padding-left: 7%;">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 20%;">
                                <span style="font-weight: bold; font-size: 11px;">SALESMAN SIGNATURE</span>
                            </td>
                            <td style="width: 20%;">
                                <span style="font-weight: bold; font-size: 11px;">EXECUTIVE SIGNATURE</span>
                            </td>
                            <td style="width: 30%;">
                                <span style="font-weight: bold; font-size: 12px;">MARKETING MANAGER</span>
                            </td>
                            <td style="width: 30%;">
                                <span style="font-weight: bold; font-size: 14px;">AGENT SIGNATURE</span>
                            </td>
                        </tr>
                    </table>
                </div>
