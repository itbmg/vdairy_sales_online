<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="DayEndReport.aspx.cs" Inherits="DayEndReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Day End Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Day End Report Details
                </h3>
            </div>
            <div class="box-body">
                        ...
                        <div id="divPrint">
                            <div style="width: 100%;">
                                ...
                                <div style="width: 100%;">
                                    <span style="font-size: 18px; font-weight: bold; padding-left: 37%; text-decoration: underline;
                                        color: #0252aa;">Day End Report</span><br />
                                    <div>
                            ...
                            <div style="width: 100%;">
                                <asp:GridView ID="grdDenomination" runat="server" ForeColor="White" Width="100%"
                                    CssClass="EU_DataTable" GridLines="Both" Font-Bold="true">
