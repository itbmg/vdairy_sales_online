<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RouteWiseDueAgentsAvgSales.aspx.cs" Inherits="RouteWiseDueAgentsAvgSales" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Route Wise Indent Classification<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Route Wise Indent Classification</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Route Wise Indent Classification
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <asp:Panel ID="pnlHide" runat="server" Visible="false">
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">Route Wise Indent ClassificationT
                                                </span>
                                        </div>
                                        <div style="width: 100%;">
                                            <br/>
                                    ...
                                    <asp:GridView ID="grdReports" runat="server" CellPadding="5" CellSpacing="5" ForeColor="White"
                                        Font-Bold="True" Width="100%" Height="400px" CssClass="gridcls" 
                                        GridLines="Both" onrowdatabound="grdReports_RowDataBound">
                                ...
                                <br />
                                <asp:Button ID="btnPrint" Text="Print" CssClass="btn btn-primary"  OnClientClick="javascript:CallPrint('divPrint');" runat="Server" />
