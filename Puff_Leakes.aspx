<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Puff_Leakes.aspx.cs" Inherits="Puff_Leakes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Puff Leaks Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Puff Leaks Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Puff Leaks Report Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <div id="divPrint">
                                <div align="center">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">Puff Leaks
                                                REPORT</span>
                                        </div>
                                        <div style="width: 100%;">
                                            <br />
                                            <div>
                                                <div style="width: 40%; float: left; padding-left: 4%;">
                                                    ...
                                                    <asp:Label ID="lblFromDate" runat="server" ForeColor="Red" Font-Size="14px" Text=""></asp:Label>
                                                     <span style="color: #0252aa; margin-right: 4%; font-size: 14px;">To Date: </span>
                                                    <asp:Label ID="lblTodate" runat="server" ForeColor="Red" Font-Size="14px" Text=""></asp:Label>
                                                </div>
                                ...
                                <table align="center">
                                    <tr>
                                        <td align="center">
                                            <asp:Label ID="lblpuffLeak" runat="server" Text="" ForeColor="Red" Font-Size="18px" Font-Bold="true"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
