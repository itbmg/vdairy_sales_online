...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fillDC_Products(msg) {
            ...
            var Tot_pkt_qty = 0;
            for (var i = 0; i < msg.length; i++) {
                if (parseFloat(msg[i].Offerpkt_qty) != 0) {
                    ...
                    if (itemcode == "Inventory") {
                        ...
                        results += '<td data-title="brandstatus" class="2">' + parseFloat(msg[i].Offerpkt_qty).toFixed(2) + '</td>';
                        results += '<td data-title="brandstatus" style="display:none;" class="2">' + parseFloat(msg[i].qty).toFixed(2) + '</td>';
                        results += '<td data-title="brandstatus" class="2">' + msg[i].Offerrate + '</td>';
                        results += '<td data-title="brandstatus" class="2">' + msg[i].discount + '</td>';
                        results += '<td data-title="brandstatus" class="2">' + parseFloat(msg[i].Offertaxablevalue).toFixed(2) + '</td>';
                        tot_qty += parseFloat(msg[i].qty);
                        Tot_pkt_qty += parseFloat(msg[i].Offerpkt_qty);
                        tot_taxablevalue += parseFloat(msg[i].Offertaxablevalue);
                        tot_sgstamount += parseFloat(msg[i].Offersgstamount);
                        tot_cgstamount += parseFloat(msg[i].Offercgstamount);
                        tot_igstamount += parseFloat(msg[i].Offerigstamount);
                        tot_totalamount += parseFloat(msg[i].Offertotalamount);
                        results += '<td data-title="brandstatus" class="2">' + msg[i].Offersgst + '</td>';
                        results += '<td data-title="brandstatus" class="2">' + parseFloat(msg[i].Offersgstamount).toFixed(2) + '</td>';
                        results += '<td data-title="brandstatus" class="2">' + msg[i].cgst + '</td>';
                        results += '<td data-title="brandstatus" class="2">' + parseFloat(msg[i].Offercgstamount).toFixed(2) + '</td>';
                        results += '<td data-title="brandstatus" class="2">' + msg[i].igst + '</td>';
                        results += '<td data-title="brandstatus" class="2">' + parseFloat(msg[i].Offerigstamount).toFixed(2) + '</td>';
                        var total = 0;
                        results += '<td data-title="brandstatus" class="2">' + parseFloat(msg[i].Offertotalamount).toFixed(2) + '</td></tr>';
                    }
                }
            }
            var Total = "Total";
            ...
            results += '<td style = "font-size: 12px;text-align:center;display:none;"><label>' + parseFloat(tot_qty).toFixed(2) + '</label></td>';
