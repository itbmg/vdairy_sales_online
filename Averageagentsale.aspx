<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Averageagentsale.aspx.cs" Inherits="Averageagentsale" %>
        ...
        <ContentTemplate>
            <table>
                <tr>
                    ...
                    <td>
                       <asp:Label ID="Label1" runat="server" Font-Bold="true" Font-Size="14px" ForeColor="Black" Text="Average Between:"></asp:Label>
                    
                    </td>
                    <td>
                    <asp:TextBox ID="txtavg1" runat="server" Width="35px"></asp:TextBox>
                    
                    </td>
                    <td>
                    <asp:TextBox ID="txtavg2" runat="server" Width="35px"></asp:TextBox>
